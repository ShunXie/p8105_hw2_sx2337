...
Now join the snp into pols. So pols are the dataframe that need to contain all the values. Then join unemployment into pols_snp, so pols_snp contains all the values. 
```{r}
